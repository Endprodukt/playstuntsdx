/** Broderbund Stunts 1.1 contact pass for reconstructed track geometry at 20 Hz.
...
import {wheelPlaneContact,BRODERBUND_1991_FALL_INCREMENTS} from './wheel-plane-contact.ts';
  ...
  for (;;) {
    ...
    for (let w = 0; w < 4; w++) {
      ...
      const result = wheelPlaneContact({
        ...
        fallIncrement: BRODERBUND_1991_FALL_INCREMENTS[w],
