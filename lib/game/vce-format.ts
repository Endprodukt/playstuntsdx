 ...
 * one reserved u32, count*u32 payload-relative offsets, then resource data.
 */
export function parseVce(bytes:Uint8Array):VceFile{
 ...
 const namesAt=6,reservedAt=namesAt+count*4,offsetsAt=reservedAt+4,payloadAt=offsetsAt+count*4;
